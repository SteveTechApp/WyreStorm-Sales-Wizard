...
export const AV_DESIGN_KNOWLEDGE_BASE = {
  ...
  productSelectionRules: {
    ...
    networkHDInteroperability: "Different NetworkHD series (e.g., 100, 400, 500, 600) ARE NOT interoperable on the same network switch. You MUST NOT mix series within a single system design. If a project requires different series, they must be on completely isolated networks with their own dedicated network switch and controller (NHD-CTL-PRO).",
