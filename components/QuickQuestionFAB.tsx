  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-8 right-8 btn-accent text-[#4CAF50] rounded-full p-6 shadow-2xl z-40 transition-transform duration-200 hover:scale-110 animate-pulse-bright"
