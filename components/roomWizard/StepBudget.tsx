...
const StepBudget: React.FC<StepBudgetProps> = ({ answers, updateAnswers, errors }) => {
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              className={`w-full p-2 pl-7 border rounded-md bg-input-bg ${errors.budget ? 'border-destructive' : 'border-border-color'}`}
              placeholder="5000"
            />
          </div>
