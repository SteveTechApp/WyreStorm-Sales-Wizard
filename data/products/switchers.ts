...
export const SWITCHERS_PRESENTATION: Product[] = [
    ...
    },
    {
        ...
        msrp: 450, dealerPrice: 300, tags: ['Switcher', 'HDMI', '4K', 'Bronze'],
    },
    {
        sku: 'SW-510-TX',
        ...
        msrp: 1200, dealerPrice: 800, tags: ['HDBaseT', '4K', 'Switcher', 'CEC', 'Silver'],
    },
    {
        sku: 'SW-640L-TX-W',
        ...
        msrp: 2000, dealerPrice: 1500, tags: ['Switcher', 'USB-C', 'Casting', '4K', 'Gold'],
    },
];
...
export const SWITCHERS_MATRIX: Product[] = [
     {
        ...
        msrp: 2200, dealerPrice: 1600, tags: ['Matrix', 'Multiview', '4K', 'Silver'],
    },
    {
        sku: 'MX-0804-EDU',
        ...
        msrp: 2800, dealerPrice: 2100, tags: ['Matrix', 'Education', 'Audio', 'Silver'],
    },
    {
        sku: 'MX-1007-HYB',
        ...
        msrp: 7500, dealerPrice: 5500, tags: ['Matrix', 'HDBaseT', 'DSP', '4K', 'Gold'],
    },
];