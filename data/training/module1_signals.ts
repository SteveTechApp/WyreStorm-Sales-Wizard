...
export const MODULE_1_SIGNALS: TrainingModule = {
  ...
  contentPages: [
    ...
    },
    {
      ...
      asset: {
        url: 'https://i.imgur.com/gJ59h3A.png',
    ...
    },
    {
      ...
      content:
        '**HDCP** (High-bandwidth Digital Content Protection) is an encryption standard built into HDMI and other connections to prevent illegal copying of content from sources like Blu-ray players or streaming services.\n\n- Every device in the signal chain (source, switcher, extender, display) **must support the same version** of HDCP for the image to appear.\n- **HDCP 2.2** or higher is required for most **4K** content.',
      asset: {
        url: 'https://images.unsplash.com/photo-1593642702821-c8626f19f1c4?w=800&q=80',
        title: 'HDCP ensures a secure, encrypted link between source and display.',
        type: 'image',
      }
    },
  ],
