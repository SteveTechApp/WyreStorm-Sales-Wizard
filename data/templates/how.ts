...
export const HOW_TEMPLATES: UserTemplate[] = [
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                { sku: 'SW-0401-H2', name: '4x1 4K/60Hz 4:2:0 HDMI Switcher', quantity: 1, category: 'Presentation Switcher', description: 'A simple and reliable 4-input HDMI switcher with auto-switching functionality.', tags: ['Switcher', 'HDMI', '4K', 'Bronze', '4x1', '4K30', '4:2:0', 'Auto-switching'] },
            ],
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                ...
                { sku: 'NHD-120-RX', name: 'NetworkHD 120 Series 4K H.264/H.265 Decoder', quantity: 2, category: 'AVoIP Decoder', description: 'Decoder for the NetworkHD 120 series.', tags: ['NetworkHD', 'AVoIP', 'Decoder', '4K', 'H.264', 'H.265', '1GbE', '4K30'] },
            ],
            constructionDetails: { wallConstruction: 'drywall', cableContainment: 'conduit', furnitureType: 'fixed' },
