...
export const CORPORATE_TEMPLATES: UserTemplate[] = [
    {
    ...
    },
     {
        ...
        roomData: {
            ...
            functionalityStatement: 'A premium, fully-featured boardroom designed for executive meetings. A powerful SW-640L-TX-W presentation switcher handles multiple 4K sources, including native USB-C and wireless casting, driving two main 4K displays independently. A discrete PTZ camera captures the room for video conferencing, and audio is handled by two ceiling microphones for crystal-clear conferencing. The entire room is managed via a SYN-TOUCH10 touch panel, which provides IP control of the switcher and camera, while a SYN-CTL-HUB integrates control for other devices like displays.',
            manuallyAddedEquipment: [
                { sku: 'SW-640L-TX-W', name: '6-Input 4K/60Hz Presentation Switcher with USB-C & Wireless Casting', quantity: 1, category: 'Presentation Switcher', description: 'Dual output 4K presentation switcher with wireless casting, USB-C, and USB host for peripherals. A high-performance solution for boardrooms.', tags: ['Switcher', 'USB-C', 'Casting', '4K', 'Gold', '6x2', 'Dual Output', 'USB Host', 'BYOM', 'Wireless'] },
                ...
                { sku: 'SYN-CTL-HUB', name: 'Ethernet Protocol Converter for the SYN-TOUCH10', quantity: 1, category: 'Control', description: 'RS232 | Relay | IR', tags: ['Control', 'Gateway', 'Synergy'] },
            ],
    ...
    },
    {
        ...
        roomData: {
            ...
            videoWallConfig: { type: 'led', layout: { rows: 1, cols: 1 }, technology: 'avoip', multiviewRequired: false },
            features: [{ name: 'Speech Reinforcement', priority: 'must-have' }],
