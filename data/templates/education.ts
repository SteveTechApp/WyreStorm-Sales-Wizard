...
export const EDUCATION_TEMPLATES: UserTemplate[] = [
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                ...
                { sku: 'APO-SKY-MIC', name: 'Apollo™ companion Add-On Ceiling Mic', quantity: 1, category: 'Microphone', description: 'RJ45 connection', tags: ['Microphone', 'Ceiling'] },
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                { sku: 'NHD-500-TX', name: 'NetworkHD 500 Series 4K60 JPEG-XS Encoder', quantity: 7, category: 'AVoIP Encoder', description: 'Visually lossless 4K60 4:4:4 video over 1GbE.', tags: ['NetworkHD', 'AVoIP', 'Encoder', '4K', 'JPEG-XS', 'Dante', '1GbE', '4K60', '4:4:4', 'Low Latency'] },
                { sku: 'NHD-500-RX', name: 'NetworkHD 500 Series 4K60 JPEG-XS Decoder', quantity: 7, category: 'AVoIP Decoder', description: 'Decoder for the 500 series with USB 2.0 KVM support.', tags: ['NetworkHD', 'AVoIP', 'Decoder', '4K', 'JPEG-XS', 'Dante', '1GbE', '4K60', '4:4:4', 'USB', 'KVM'] },
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                { sku: 'SW-0201-4K', name: '2x1 USB-C & HDMI Wireless Switcher', quantity: 4, category: 'Presentation Switcher', description: 'A compact 2x1 presentation switcher with HDMI and USB-C inputs, featuring auto-switching and wireless casting support.', tags: ['Switcher', 'USB-C', 'Casting', '4K', 'Bronze', 'HDMI', 'Auto-switching', '2x1'] },
            ],
    ...
    },
    {
        ...
        roomData: {
            ...
            manuallyAddedEquipment: [
                ...
                { sku: 'GEN-DOC-CAM', name: 'Document Camera', quantity: 1, category: 'Source', description: 'A camera for displaying physical documents or objects to the main screen.', tags: ['Source', 'Camera'] },
            ],
