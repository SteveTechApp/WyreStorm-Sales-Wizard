...
export const GOVERNMENT_TEMPLATES: UserTemplate[] = [
    ...
    },
    {
        ...
        roomData: {
            ...
            audioSystemDetails: { speakerLayout: 'soundbar', systemType: 'low_impedance', useCases: ['speech_reinforcement'] },
            technicalDetails: { primaryVideoResolution: '4K/60Hz 4:4:4', videoSignalTypes: ['HDMI', 'DisplayPort'], controlSystem: 'None (Auto-switching)' },
            budget: 40000,
        },
    },
    {
        ...
        roomData: {
            ...
            audioSystemDetails: { speakerLayout: 'in_ceiling', systemType: 'high_impedance', useCases: ['speech_reinforcement', 'video_conferencing'] },
            technicalDetails: { primaryVideoResolution: '1080p', videoSignalTypes: ['HDMI', 'VGA'], controlSystem: 'Touch Panel' },
            budget: 90000,
        },
    },
    {
    ...
    },
    {
        ...
        roomData: {
            ...
            technicalDetails: { primaryVideoResolution: '4K/60Hz 4:4:4', videoSignalTypes: ['DisplayPort'], controlSystem: 'Third-Party Integration' },
            budget: 80000,
        },
    }
];