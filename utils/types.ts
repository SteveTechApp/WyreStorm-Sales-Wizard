...
export interface RoomData {
    ...
    displayType?: 'Projector' | 'Large Format Display' | 'Video Wall';
    displayCount?: number;
...
export type RoomWizardAnswers = Omit<RoomData, 'id' | 'functionalityStatement' | 'manuallyAddedEquipment' | 'constructionDetails' | 'audioSystemDetails' | 'displayType' | 'displayCount' | 'primarySources'>;
